...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  final public BinAndExpression BinAndExpression() throws ParseException {
  ...
  final public BinOrExpression BinOrExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
  ...
  final public BinXorExpression BinXorExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
  ...
  final public BinNotExpression BinNotExpression() throws ParseException {
   NodeToken n0;
   Token n1;
  ...
  final public LessThanOrEqualExpression LessThanOrEqualExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
  ...
  final public GreaterThanOrEqualExpression GreaterThanOrEqualExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
  ...
  final public TernaryExpression TernaryExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   Expression n2;
   NodeToken n3;
  ...
  final public PublicReadExpression PublicReadExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
  ...
  final public PrivateReadExpression PrivateReadExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
