...
public class ShiftRightExpression implements Node {
   ...
   public ShiftRightExpression(PrimaryExpression n0, NodeToken n1, PrimaryExpression n2) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
   }

   public ShiftRightExpression(PrimaryExpression n0, PrimaryExpression n1) {
      f0 = n0;
      f1 = new NodeToken(">>");
      f2 = n1;
   }
