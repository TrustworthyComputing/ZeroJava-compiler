/* Generated By:JavaCC: Do not edit this line. ZilchParser.java */
import syntaxtree.*;
import java.util.Vector;


public class ZilchParser implements ZilchParserConstants {
  ...
  final public Statement Statement() throws ParseException {
   ...
   PlusPlusExpression n4;
   MinusMinusExpression n5;
   IfStatement n6;
   WhileStatement n7;
   PrintStatement n8;
   ReadPrimaryTape n9;
   ...
   AnswerStatement n13;
    ...
    default:
      ...
      if (jj_2_4(2)) {
        ...
        n4 = PlusPlusExpression();
        n0 = new NodeChoice(n4, 3);
      } else if (jj_2_7(2147483647)) {
        n5 = MinusMinusExpression();
  ...
  final public SeekPrimaryTape SeekPrimaryTape() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n11;
    ...
    n11 = jj_consume_token(SEMICOLON);
             n10 = JTBToolkit.makeNodeToken(n11);
     {if (true) return new SeekPrimaryTape(n0,n2,n4,n5,n7,n8,n10);}
    throw new Error("Missing return statement in function");
  }

  final public SeekPrivateTape SeekPrivateTape() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Token n11;
    ...
    n11 = jj_consume_token(SEMICOLON);
             n10 = JTBToolkit.makeNodeToken(n11);
     {if (true) return new SeekPrivateTape(n0,n2,n4,n5,n7,n8,n10);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public PlusPlusExpression PlusPlusExpression() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   Token n4;
    n0 = Identifier();
    n2 = jj_consume_token(PLUSPLUS);
             n1 = JTBToolkit.makeNodeToken(n2);
    n4 = jj_consume_token(SEMICOLON);
            n3 = JTBToolkit.makeNodeToken(n4);
     {if (true) return new PlusPlusExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public MinusMinusExpression MinusMinusExpression() throws ParseException {
   Identifier n0;
   NodeToken n1;
   Token n2;
   NodeToken n3;
   Token n4;
    n0 = Identifier();
    n2 = jj_consume_token(MINUSMINUS);
             n1 = JTBToolkit.makeNodeToken(n2);
    n4 = jj_consume_token(SEMICOLON);
            n3 = JTBToolkit.makeNodeToken(n4);
     {if (true) return new MinusMinusExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  public ZilchParserTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000000,0x2000,0x8000000,0x2000,0x0,0x8000000,0x2000,0x0,0x2000,0x4000200,0x4000200,0x4000200,0x0,0x4000200,0x0,0x200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x4008,0x7c4806,0x4008,0x7c4806,0x20000,0x4008,0x0,0x7c0806,0x7c4806,0x6421,0x6421,0x6421,0x20000,0x6421,0x6401,0x20,};
   }
  ...
  public ZilchParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public ZilchParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new ZilchParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public ZilchParser(java.io.Reader stream) {
  ...
  public ZilchParser(ZilchParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(ZilchParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
