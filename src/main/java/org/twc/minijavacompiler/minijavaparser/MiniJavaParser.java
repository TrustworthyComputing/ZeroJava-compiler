...
public class MiniJavaParser implements MiniJavaParserConstants {
  ...
  static final public FormalParameterTail FormalParameterTail() throws ParseException {
  ...
  static final public FormalParameterTerm FormalParameterTerm() throws ParseException {
   NodeToken n0;
   Token n1;
   FormalParameter n2;
  ...
  static final public AnswerStatement AnswerStatement() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
  ...
  static final public Expression Expression() throws ParseException {
   ...
   BinXorExpression n5;
   BinNotExpression n6;
   ShiftLeftExpression n7;
   ShiftRightExpression n8;
   EqualExpression n9;
   NotEqualExpression n10;
   LessThanExpression n11;
   LessThanOrEqualExpression n12;
   GreaterThanExpression n13;
   GreaterThanOrEqualExpression n14;
   PlusExpression n15;
   MinusExpression n16;
   TimesExpression n17;
   DivExpression n18;
   ...
   ArrayLength n20;
   MessageSend n21;
   TernaryExpression n22;
   PublicReadExpression n23;
   PrivateReadExpression n24;
   Clause n25;
    if (jj_2_8(2147483647)) {
      ...
      n22 = TernaryExpression();
        n0 = new NodeChoice(n22, 21);
    } else if (jj_2_30(2147483647)) {
      n23 = PublicReadExpression();
        n0 = new NodeChoice(n23, 22);
    } else if (jj_2_31(2147483647)) {
      n24 = PrivateReadExpression();
  ...
  static final public BinAndExpression BinAndExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    n0 = PrimaryExpression();
    n2 = jj_consume_token(BINAND);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new BinAndExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public BinOrExpression BinOrExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    n0 = PrimaryExpression();
    n2 = jj_consume_token(BINOR);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new BinOrExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public BinXorExpression BinXorExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    n0 = PrimaryExpression();
    n2 = jj_consume_token(BINXOR);
            n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new BinXorExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public BinNotExpression BinNotExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   PrimaryExpression n2;
    n1 = jj_consume_token(BINNOT);
            n0 = JTBToolkit.makeNodeToken(n1);
    n2 = PrimaryExpression();
     {if (true) return new BinNotExpression(n0,n2);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public EqualExpression EqualExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(61);
             n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new EqualExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }

  static final public NotEqualExpression NotEqualExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(62);
             n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new NotEqualExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public LessThanOrEqualExpression LessThanOrEqualExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    ...
    n2 = jj_consume_token(LTE);
             n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new LessThanOrEqualExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public GreaterThanOrEqualExpression GreaterThanOrEqualExpression() throws ParseException {
   PrimaryExpression n0;
   NodeToken n1;
   Token n2;
   PrimaryExpression n3;
    n0 = PrimaryExpression();
    n2 = jj_consume_token(GTE);
             n1 = JTBToolkit.makeNodeToken(n2);
    n3 = PrimaryExpression();
     {if (true) return new GreaterThanOrEqualExpression(n0,n1,n3);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public TernaryExpression TernaryExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   Expression n2;
   NodeToken n3;
   ...
   Expression n10;
    ...
    n6 = jj_consume_token(65);
            n5 = JTBToolkit.makeNodeToken(n6);
    n7 = Expression();
    n9 = jj_consume_token(66);
            n8 = JTBToolkit.makeNodeToken(n9);
    n10 = Expression();
     {if (true) return new TernaryExpression(n0,n2,n3,n5,n7,n8,n10);}
    throw new Error("Missing return statement in function");
  }

  static final public PublicReadExpression PublicReadExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   NodeToken n4;
   Token n5;
    n1 = jj_consume_token(PUBLIC_READ);
                      n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(LPAREN);
            n2 = JTBToolkit.makeNodeToken(n3);
    n5 = jj_consume_token(RPAREN);
            n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new PublicReadExpression(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }

  static final public PrivateReadExpression PrivateReadExpression() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   NodeToken n4;
   Token n5;
    n1 = jj_consume_token(PRIVATE_READ);
                       n0 = JTBToolkit.makeNodeToken(n1);
    n3 = jj_consume_token(LPAREN);
            n2 = JTBToolkit.makeNodeToken(n3);
    n5 = jj_consume_token(RPAREN);
            n4 = JTBToolkit.makeNodeToken(n5);
     {if (true) return new PrivateReadExpression(n0,n2,n4);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ExpressionTail ExpressionTail() throws ParseException {
   NodeListOptional n0 = new NodeListOptional();
   ExpressionTerm n1;
    label_12:
    while (true) {
  ...
  static final public ExpressionTerm ExpressionTerm() throws ParseException {
   NodeToken n0;
   Token n1;
   Expression n2;
    n1 = jj_consume_token(60);
  ...
  static private boolean jj_3R_98() {
    if (jj_scan_token(PRIVATE_READ)) return true;
  ...
  static private boolean jj_3R_77() {
    ...
    if (jj_scan_token(BINAND)) return true;
    if (jj_3R_20()) return true;
    return false;
  }
  ...
  static private boolean jj_3R_97() {
    if (jj_scan_token(PUBLIC_READ)) return true;
    if (jj_scan_token(LPAREN)) return true;
    if (jj_scan_token(RPAREN)) return true;
    return false;
  }
  ...
  static private boolean jj_3_13() {
    if (jj_scan_token(BINNOT)) return true;
    if (jj_3R_20()) return true;
    return false;
  }
  ...
  static private boolean jj_3_12() {
    if (jj_3R_20()) return true;
    if (jj_scan_token(BINXOR)) return true;
    return false;
  }
  ...
  static private boolean jj_3_11() {
    if (jj_3R_20()) return true;
    if (jj_scan_token(BINOR)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x0,0x2000,0x0,0x0,0x0,0x0,0x0,0x0,0x2000,0x0,0x0,0x2000,0x0,0x2000,0x0,0x4000200,0x24000200,0x0,0x4000200,0x0,0x200,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x4,0x2180180,0x4,0x2000202,0x2000,0x2000202,0x2000,0x2000202,0x2180180,0x10000000,0x2000202,0x0,0x180180,0x2180180,0x80,0x3061040,0x3661040,0x10000000,0x3061040,0x3060040,0x1000,};
   }
