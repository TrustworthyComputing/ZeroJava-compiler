 ...
 * f6 -> ";"
 */
public class SeekPrivateTape implements Node {
   public NodeToken f0;
   public NodeToken f1;
   ...
   public SeekPrivateTape(NodeToken n0, NodeToken n1, Expression n2, NodeToken n3, Expression n4, NodeToken n5, NodeToken n6) {
      f0 = n0;
      f1 = n1;
      f2 = n2;
      f3 = n3;
   ...
   public SeekPrivateTape(Expression n0, Expression n1) {
      f0 = new NodeToken("PrivateTape.seek");
      f1 = new NodeToken("(");
      f2 = n0;
      f3 = new NodeToken(",");
      f4 = n1;
